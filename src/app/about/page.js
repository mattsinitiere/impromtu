  ...
  return (
    <section className="wrap sec first">
      ...
      <div className="prose">
        ...
        <p>What you write stays in your browser unless you make an account, and then it stays in your account. There is no analytics and nothing is sold. Grading is free during the beta, capped at three takes a day because each one costs real money. The recording goes to OpenAI only when you press Record, and is not kept. <Link href="/privacy">The details</Link>.</p>
      </div>
