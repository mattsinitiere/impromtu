  ...
  const topicCard = (
    <section className="dl-card dl-topic-card" aria-labelledby="topic-title">
      ...
      <div className="dl-topic-actions">
        <button className="dl-button dl-primary" onClick={() => step === 3 ? drawTopic() : step === 0 ? setStep(1) : setStep(Math.min(step + 1, 3))}>
